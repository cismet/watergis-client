 ...
 */
public class FgBakGn3RuleSet extends DefaultAttributeTableRuleSet {
    ...
    public Object afterEdit(final FeatureServiceFeature feature,
        ...
        if (column.equals("gn3") && (newValue == null)) {
            JOptionPane.showMessageDialog(AppBroker.getInstance().getWatergisApp(),
                "Das Attribut gn3 darf nicht null sein");
            return oldValue;
        }
        return newValue;
    }
