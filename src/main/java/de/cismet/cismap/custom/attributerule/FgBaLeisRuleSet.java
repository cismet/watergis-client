...
public class FgBaLeisRuleSet extends WatergisDefaultRuleSet {
    ...
    public Object afterEdit(final FeatureServiceFeature feature,
        ...
        if (newValue == null) {
            if (column.equals("leis") || column.equals("ww_gr") || column.equals("l_rl")) {
    ...
    public TableCellEditor getCellEditor(final String columnName) {
        if (columnName.equals("ww_gr")) {
            ...
            filter = createCidsBeanFilter("leis");
    ...
    public boolean prepareForSave(final List<FeatureServiceFeature> features, final TableModel model) {
        for (final FeatureServiceFeature feature : features) {
            if (feature.getProperty("leis") == null) {
                JOptionPane.showMessageDialog(AppBroker.getInstance().getWatergisApp(),
                    "Das Attribut leis darf nicht leer sein");
                return false;
            }
