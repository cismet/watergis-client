 ...
 */
public class LandnutzRuleSet extends WatergisDefaultRuleSet {

    //~ Instance initializers --------------------------------------------------

    {
        typeMap.put("geom", new Geom(true, false));
        typeMap.put("nutzung_id", new Numeric(2, 0, false, true));
    ...
    public boolean isColumnEditable(final String columnName) {
        return !columnName.equals("geom") && !columnName.equals("id") && !columnName.equals("flaeche");
    }
