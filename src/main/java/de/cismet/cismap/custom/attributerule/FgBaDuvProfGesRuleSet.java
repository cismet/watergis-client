 ...
 */
public class FgBaDuvProfGesRuleSet extends WatergisDefaultRuleSet {
...

    {
        ...
        typeMap.put("br_r", new Numeric(5, 2, false, true));
        typeMap.put("br_l", new Numeric(5, 2, false, true));
