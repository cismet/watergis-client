 ...
 */
public class SgUmringProfRuleSet extends WatergisDefaultRuleSet {
...

    {
        ...
        typeMap.put("see_id", new Numeric(12, 0, false, false));
        typeMap.put("see_st_von", new Numeric(10, 2, false, true));
        typeMap.put("see_st_bis", new Numeric(10, 2, false, true));
    ...
    public boolean isColumnEditable(final String columnName) {
        return !columnName.equals("fis_g_user") && !columnName.equals("fis_g_date") && !columnName.equals("id")
                    && !columnName.equals("laenge") && !columnName.equals("ww_gr") && !columnName.equals("see_id")
    ...
    public FeatureCreator getFeatureCreator() {
        final MetaClass routeMc = ClassCacheMultiple.getMetaClass(AppBroker.DOMAIN_NAME, "dlm25w.sg_umring");
