 ...
 */
public class FgBaDuvGesAusRuleSet extends WatergisDefaultRuleSet {
...
//        typeMap.put("ww_gr", new Catalogue("k_ww_gr", true, true, new Numeric(4, 0, false, false)));
    ...
    public TableCellEditor getCellEditor(final String columnName) {
        if (columnName.equals("ba_st_von")) {
            ...
            return new StationTableCellEditor(columnName);
        } else if (columnName.equals("seite")) {
            ...
            editor.setListRenderer(new AbstractCidsLayerListCellRenderer() {
                    ...
                    protected String toString(final CidsLayerFeature bean) {
                        return (String)bean.getProperty("seite");
                    }
                });
    ...
    public FeatureCreator getFeatureCreator() {
        final MetaClass routeMc = ClassCacheMultiple.getMetaClass(AppBroker.DOMAIN_NAME, "duv.fg_ba_duv_ges");
