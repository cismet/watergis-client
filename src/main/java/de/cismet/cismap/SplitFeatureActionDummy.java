...
@ServiceProvider(
    ...
    supersedes = { "de.cismet.cids.custom.actions.wrrl_db_mv.SplitFeatureAction" }
)
public class SplitFeatureActionDummy extends AbstractAction implements CommonFeatureAction {
     ...
     */
    public SplitFeatureActionDummy() {
        super("");
    }
