 ...
 */
public class Dlm25wKWehrAvToStringConverter extends CustomToStringConverter
    ...
    public String createString() {
        String name = String.valueOf(cidsBean.getProperty("wehr_av"));
    ...
    public String featureToString(final Object feature) {
        if (feature instanceof CidsLayerFeature) {
            ...
            String name = String.valueOf(cidsFeature.getProperty("wehr_av"));
