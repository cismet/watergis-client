 ...
 */
public class Dlm25wKTechToStringConverter extends CustomToStringConverter implements CidsLayerFeatureToStringConverter {
...
// private static Map<String, String> map = new Hashtable<String, String>();
    ...
    public String featureToString(final Object feature) {
        if (feature instanceof CidsLayerFeature) {
            ...
            final String name = String.valueOf(cidsFeature.getProperty("tech"));
