 ...
 */
public class Dlm25wKEaToStringConverter extends CustomToStringConverter implements CidsLayerFeatureToStringConverter {
...
// private static Map<String, String> map = new Hashtable<String, String>();
    ...
    public String createString() {
        String name = String.valueOf(cidsBean.getProperty("ea"));
    ...
    public String featureToString(final Object feature) {
        if (feature instanceof CidsLayerFeature) {
            ...
            String name = String.valueOf(cidsFeature.getProperty("ea"));
