 ...
 */
public class Dlm25wKGmdToStringConverter extends CustomToStringConverter implements CidsLayerFeatureToStringConverter {
...
// private static Map<String, String> map = new Hashtable<String, String>();
    ...
    public String createString() {
        String name = String.valueOf(cidsBean.getProperty("gmd"));
    ...
    public String featureToString(final Object feature) {
        if (feature instanceof CidsLayerFeature) {
            ...
            String name = String.valueOf(cidsFeature.getProperty("gmd"));
