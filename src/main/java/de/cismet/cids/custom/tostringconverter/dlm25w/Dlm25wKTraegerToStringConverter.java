 ...
 */
public class Dlm25wKTraegerToStringConverter extends CustomToStringConverter
...
// private static Map<String, String> map = new Hashtable<String, String>();
    ...
    public String createString() {
        String name = String.valueOf(cidsBean.getProperty("traeger"));
    ...
    public String featureToString(final Object feature) {
        if (feature instanceof CidsLayerFeature) {
            ...
            String name = String.valueOf(cidsFeature.getProperty("traeger"));
