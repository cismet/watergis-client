 ...
 */
public class Dlm25wKQpGafBkToStringConverter extends CustomToStringConverter
    ...
    public String createString() {
        String name = String.valueOf(cidsBean.getProperty("bk"));
    ...
    public String featureToString(final Object feature) {
        if (feature instanceof CidsLayerFeature) {
            ...
            String name = String.valueOf(cidsFeature.getProperty("bk"));
