 ...
 */
public class Dlm25wKHBezugToStringConverter extends CustomToStringConverter
    ...
    public String createString() {
        String name = String.valueOf(cidsBean.getProperty("h_bezug"));
    ...
    public String featureToString(final Object feature) {
        if (feature instanceof CidsLayerFeature) {
            ...
            String name = String.valueOf(cidsFeature.getProperty("h_bezug"));
