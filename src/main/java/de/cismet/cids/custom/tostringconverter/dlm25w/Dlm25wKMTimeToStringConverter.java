 ...
 */
public class Dlm25wKMTimeToStringConverter extends CustomToStringConverter
    ...
    public String createString() {
        String name = (String)cidsBean.getProperty("time");
    ...
    public String featureToString(final Object feature) {
        if (feature instanceof CidsLayerFeature) {
            ...
            String name = (String)cidsFeature.getProperty("time");
