 ...
 */
public class Dlm25wKApsfrToStringConverter extends CustomToStringConverter
    ...
    public String createString() {
        String name = String.valueOf(cidsBean.getProperty("apsfr_cd"));
    ...
    public String featureToString(final Object feature) {
        if (feature instanceof CidsLayerFeature) {
            ...
            String name = String.valueOf(cidsFeature.getProperty("apsfr_cd"));
