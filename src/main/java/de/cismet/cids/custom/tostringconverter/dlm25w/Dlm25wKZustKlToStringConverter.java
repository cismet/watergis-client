 ...
 */
public class Dlm25wKZustKlToStringConverter extends CustomToStringConverter
    ...
    public String createString() {
        String name = String.valueOf(cidsBean.getProperty("zust_kl"));
    ...
    public String featureToString(final Object feature) {
        if (feature instanceof CidsLayerFeature) {
            ...
            String name = String.valueOf(cidsFeature.getProperty("zust_kl"));
