...
public class SelectFromSelectionQuerySearchMethod implements QuerySearchMethod {
    ...
    public String toString() {
        return NbBundle.getMessage(
                SelectFromSelectionQuerySearchMethod.class,
                "SelectFromSelectionQuerySearchMethod.toString");
    }
        ...
        protected void done() {
            try {
                ...
                if ((features != null) && (layer instanceof AbstractFeatureService)) {
                    final List<Feature> featureToSelect = new ArrayList<Feature>();
