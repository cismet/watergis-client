...
public class ZoomSelectedDrawingsAction extends AbstractAction {
    ...
    public ZoomSelectedDrawingsAction() {
        final String tooltip = org.openide.util.NbBundle.getMessage(ZoomSelectedDrawingsAction.class,
                "ZoomSelectedDrawingsAction.toolTipText");
        putValue(SHORT_DESCRIPTION, tooltip);
        final String text = org.openide.util.NbBundle.getMessage(ZoomSelectedDrawingsAction.class,
                "ZoomSelectedDrawingsAction.text");
        putValue(NAME, text);
        final String mnemonic = org.openide.util.NbBundle.getMessage(ZoomSelectedDrawingsAction.class,
    ...
    public void actionPerformed(final ActionEvent e) {
        ...
        final ZoomToFeaturesWorker worker = new ZoomToFeaturesWorker(drawingFeatures.toArray(new Feature[drawingFeatures.size()]), 10);
        worker.execute();
    }
