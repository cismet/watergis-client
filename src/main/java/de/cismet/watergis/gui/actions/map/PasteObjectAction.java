 ...
 */
public class PasteObjectAction extends AbstractAction {
    ...
    public PasteObjectAction() {
        final String tooltip = org.openide.util.NbBundle.getMessage(
                PasteObjectAction.class,
                "PasteObjectAction.toolTipText");
        putValue(SHORT_DESCRIPTION, tooltip);
        final String text = org.openide.util.NbBundle.getMessage(PasteObjectAction.class,
                "PasteObjectAction.text");
        putValue(NAME, text);
        final String mnemonic = org.openide.util.NbBundle.getMessage(
                PasteObjectAction.class,
                "PasteObjectAction.mnemonic");
        putValue(MNEMONIC_KEY, KeyStroke.getKeyStroke(mnemonic).getKeyCode());
        final ImageIcon icon = new javax.swing.ImageIcon(getClass().getResource(
                    "/de/cismet/watergis/res/icons16/icon-pastealt.png"));
