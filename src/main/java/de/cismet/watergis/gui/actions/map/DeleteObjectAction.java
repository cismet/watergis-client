...
public class DeleteObjectAction extends AbstractAction {
    ...
    private static final Logger LOG = Logger.getLogger(DeleteObjectAction.class);
    ...
    public DeleteObjectAction() {
        final String tooltip = org.openide.util.NbBundle.getMessage(
                DeleteObjectAction.class,
                "DeleteObjectAction.toolTipText");
        putValue(SHORT_DESCRIPTION, tooltip);
        final String text = org.openide.util.NbBundle.getMessage(DeleteObjectAction.class,
                "DeleteObjectAction.text");
        putValue(NAME, text);
        final String mnemonic = org.openide.util.NbBundle.getMessage(
                DeleteObjectAction.class,
                "DeleteObjectAction.mnemonic");
