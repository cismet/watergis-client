...
public class WatergisApp extends javax.swing.JFrame implements Configurable, WindowListener {
    ...
    private de.cismet.watergis.gui.actions.map.PanModeAction panAction1;
    ...
    private de.cismet.watergis.gui.actions.map.ZoomModeAction zoomModeAction1;
...
//        }
    ...
    private void initComponents() {
        ...
        panAction1 = new de.cismet.watergis.gui.actions.map.PanModeAction();
        ...
        tbtnZoomMode.setAction(zoomModeAction1);
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jMenu1, org.openide.util.NbBundle.getMessage(WatergisApp.class, "WatergisApp.jMenu1.text")); // NOI18N
        menFile.add(jMenu1);
