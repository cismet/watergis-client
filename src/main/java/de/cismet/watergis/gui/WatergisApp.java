...
//        sw.execute();
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(menBasisChecks, org.openide.util.NbBundle.getMessage(WatergisApp.class, "WatergisApp.menBasisChecks.text")); // NOI18N
