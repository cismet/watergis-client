...
public class PhotoInfoPHandle extends PPath {
    ...
    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(PhotoInfoPHandle.class);
     ...
     */
    public PhotoInfoPHandle(final PLocator locator,
    ...
    private void initPanel() {
        fotoInfoPanel = new PhotoInfoPanel(this);

        pswingComp = new PSwing((PSwingCanvas)mc, fotoInfoPanel);
        addChild(pswingComp);
    }
    ...
    public void setPhotoSize() {
        final Dimension dim = PhotoOptionsDialog.getInstance().getPhotoSize();
        fotoInfoPanel.setPhotoSize();
