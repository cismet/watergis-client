 ...
 */
public class PointInPolygonDialog extends javax.swing.JDialog {
    ...
    /**
     * Creates new form PointInPolygonDialog.
     *
     * @param  parent  DOCUMENT ME!
     * @param  modal   DOCUMENT ME!
     */
    public PointInPolygonDialog(final java.awt.Frame parent, final boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        cbTheme.setModel(new DefaultComboBoxModel(
                new String[] {
                    NbBundle.getMessage(
                        ...
                        "PointInPolygonDialog.setlayerModel.searchPointServices")
                }));
    ...
    private void butOkActionPerformed(final java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butOkActionPerformed
        ...
        final WaitingDialogThread<H2FeatureService> wdt = new WaitingDialogThread<H2FeatureService>(AppBroker
                ...
                protected H2FeatureService doInBackground() throws Exception {
                    ...
                    if (!txtDistanceField.getText().equals("") && (buffer != 0)) {
...
//                        }
                    ...
                    wd.setText(NbBundle.getMessage(
                            PointInPolygonDialog.class,
                            "PointInPolygonDialog.butOkActionPerformed.doInBackground.creatingDatasource"));
        ...
        if (H2FeatureService.tableAlreadyExists(tableName)) {
            JOptionPane.showMessageDialog(AppBroker.getInstance().getWatergisApp(),
                NbBundle.getMessage(
                    PointInPolygonDialog.class,
                    "PointInPolygonDialog.butOkActionPerformed.tableAlreadyExists",
                    tableName),
                NbBundle.getMessage(
                    PointInPolygonDialog.class,
                    "PointInPolygonDialog.butOkActionPerformed.tableAlreadyExists.title"),
                JOptionPane.ERROR_MESSAGE);
        } else {
    ...
    public int refreshSelectedFeatureCount(final boolean forceGuiRefresh,
        ...
        selectionCountlab.setText(NbBundle.getMessage(
                PointInPolygonDialog.class,
                "PointInPolygonDialog.refreshSelectedFeatureCount.text",
                count));
