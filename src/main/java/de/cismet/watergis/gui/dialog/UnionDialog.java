 ...
 */
public class UnionDialog extends javax.swing.JDialog {
    ...
    /**
     * Creates new form UnionDialog.
     *
     * @param  parent  DOCUMENT ME!
     * @param  modal   DOCUMENT ME!
     */
    public UnionDialog(final java.awt.Frame parent, final boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle(org.openide.util.NbBundle.getMessage(UnionDialog.class, "UnionDialog.title", new Object[] {})); // NOI18N
        getContentPane().setLayout(new java.awt.GridBagLayout());

        org.openide.awt.Mnemonics.setLocalizedText(
            labTheme,
            org.openide.util.NbBundle.getMessage(UnionDialog.class, "UnionDialog.labTheme.text", new Object[] {})); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(
            butOk,
            org.openide.util.NbBundle.getMessage(UnionDialog.class, "UnionDialog.butOk.text", new Object[] {})); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(
            butCancel,
            org.openide.util.NbBundle.getMessage(UnionDialog.class, "UnionDialog.butCancel.text", new Object[] {})); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(
            ...
            org.openide.util.NbBundle.getMessage(
                UnionDialog.class,
                "UnionDialog.labTargetTheme.text",
                new Object[] {})); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(
            ...
            org.openide.util.NbBundle.getMessage(
                UnionDialog.class,
                "UnionDialog.ckbSelectedTarget.text",
                new Object[] {})); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(
            ckbSelected,
            org.openide.util.NbBundle.getMessage(UnionDialog.class, "UnionDialog.ckbSelected.text", new Object[] {})); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
    ...
    private void setLayerModel() {
        cbTheme.setModel(new DefaultComboBoxModel(
                new String[] { NbBundle.getMessage(UnionDialog.class,
                        "UnionDialog.setlayerModel.searchServices") }));
        cbTargetTheme.setModel(new DefaultComboBoxModel(
                new String[] {
                    NbBundle.getMessage(UnionDialog.class,
                        "UnionDialog.setlayerModel.searchPolygonServices")
                }));
                    ...
                    public void run() {
                        cbTheme.setModel(
                            new DefaultComboBoxModel(
                                FeatureServiceHelper.getServices(
                                    new String[] { "Polygon", "MultiPolygon", "LineString" }).toArray(
                                    new AbstractFeatureService[0])));
                        cbTargetTheme.setModel(
                            new DefaultComboBoxModel(
                                FeatureServiceHelper.getServices(
                                    new String[] { "Polygon", "MultiPolygon"}).toArray(
                                    new AbstractFeatureService[0])));
    ...
    private void butOkActionPerformed(final java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butOkActionPerformed
        ...
        final WaitingDialogThread<H2FeatureService> wdt = new WaitingDialogThread<H2FeatureService>(AppBroker
                ...
                protected H2FeatureService doInBackground() throws Exception {
                    ...
                    wd.setText(NbBundle.getMessage(
                            UnionDialog.class,
                            "UnionDialog.butOkActionPerformed.doInBackground.createFeatures"));
...
//                                        }
                    ...
                    wd.setText(NbBundle.getMessage(
                            UnionDialog.class,
                            "UnionDialog.butOkActionPerformed.doInBackground.creatingDatasource"));
        ...
        if (H2FeatureService.tableAlreadyExists(tableName)) {
            JOptionPane.showMessageDialog(AppBroker.getInstance().getWatergisApp(),
                NbBundle.getMessage(
                    UnionDialog.class,
                    "UnionDialog.butOkActionPerformed.tableAlreadyExists",
                    tableName),
                NbBundle.getMessage(
                    UnionDialog.class,
                    "UnionDialog.butOkActionPerformed.tableAlreadyExists.title"),
    ...
    public int refreshSelectedFeatureCount(final boolean forceGuiRefresh,
        ...
        selectionCountlab.setText(NbBundle.getMessage(
                UnionDialog.class,
                "UnionDialog.refreshSelectedFeatureCount.text",
                count));
